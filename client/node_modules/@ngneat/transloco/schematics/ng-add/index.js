...
function createTranslocoModule(isLib, ssr, langs, path) {
    ...
    return (host, context) => {
        ...
        return schematics_1.chain([
            options.loader === schema_1.Loaders.Http
                ...
                : schematics_1.noop(),
            translations_1.checkIfTranslationFilesExist(assetsPath, langs, '.json', true) ? schematics_1.noop() : schematics_1.mergeWith(translateFiles),
            schematics_1.mergeWith(createTranslocoModule(isLib, options.ssr, langs, modulePath)),
